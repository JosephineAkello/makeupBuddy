    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
            ...
            child: Column(children: [
              ...
              Text(
                'Contouring is giving shape to an area of the face'
              ...
              Text(
                'Before starting out contouring, find the perfect'
              ...
              Text(
                'Start contouring considering applying'
                    'foundation of your skin tone', style: TextStyle(
                  fontSize: 18.0,
                ),
              ),
              SizedBox(
              ...
              Text(
                'Next, apply foundation that is a few shades lighter'
              ...
              Text(
                'Apply foundation darker than your skin tone your'
              ...
              Text(
                'The next step is blending  to make sure to "set" your'
              ...
              Text(
                'Next is, Highlighting, also known as "strobing"is'
              ...
              Text(
                'Now you can finish the rest of your makeup! With'
