    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(children: [
          ...
          SizedBox(height: 10.0),
          Text(
            'Depending on the lasting power of your long wear lipstick,'
          ...
          SizedBox(height: 10.0),
          Text(
            'With the lip balm still on your lips, wet a soft-bristled'
          ...
          Text(
            'This won’t remove a waterproof lip color. However,'
          ...
          Text(
            'Apply a thick layer to your lips. Be sure to leave the'
          ...
          SizedBox(height: 10.0),
          Text(
            'Wipe thin layers of coconut oil onto your lips, and'
          ...
          SizedBox(height: 10.0),
          Text(
            'The mixture of little organic honey on a clean wash'
          ...
          SizedBox(height: 10.0),
          Text(
            "Just like coconut oil, olive oil is also great when"
          ...
          SizedBox(height: 10.0),
          Text(
            'If you have nothing else available, you can try'
          ...
          SizedBox(height: 10.0),
          Text(
            'Although this will dry your lips out more than coconut'
          ...
          Text(
            'Take one cucumber and blend it into a paste. Use it as'
