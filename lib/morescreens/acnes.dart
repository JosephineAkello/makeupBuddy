  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => AcneProducts()));
        },
      ),
      body: ListView(
        children: <Widget>[
          ...
          ListTile(
            ...
            subtitle: Column(children: [
              ...
              Text(
                  'Acne is a chronic inflammatory skin condition that causes spots and pimples especially on the face, shoulders,back,neck,chest and upper arms ', style: TextStyle(fontWeight: FontWeight.w400,),),
              SizedBox(
                height: 10.0,
              ),
              Text(
