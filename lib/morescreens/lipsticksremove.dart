    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(children: [
          ...
          SizedBox(height: 10.0),
          Text(
              'Depending on the lasting power of your long wear lipstick, lip balm might work to remove some'
              'or all of your lipstick. Apply a heavy coat of lip balm to your lips and wait a minute or two for it to soak in.'
          ...
          SizedBox(height: 10.0),
          Text(
              'With the lip balm still on your lips, wet a soft-bristled toothbrush and gently scrub your lips'
              'in a circular motion. Be sure to do this very lightly so you don’t hurt your lips'),
          SizedBox(height: 10.0),
          Text(
          ...
          Text(
              'Apply a thick layer to your lips. Be sure to leave the jelly on your lips for at least five minutes to let it soak in and work on the lipstick color before you use a cotton makeup remover pad or a paper towel to wipe it off'),
          Text(
          ...
          SizedBox(height: 10.0),
          Text(
              'Although this will dry your lips out more than coconut oil or petroleum jelly, standard eye makeup removal products will often do the trick on stubborn long wear lipsticks.'
              'Eye makeup remover will be especially effective if you prep your lips first by applying lip balm and then exfoliating. Put the eye makeup remover on a cotton pad or paper towel and wipe over lips, repeating if needed.'),
          Text(
