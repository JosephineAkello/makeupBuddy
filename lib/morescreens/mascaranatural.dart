...
class NaturalMascara extends StatelessWidget {
  Widget build(context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Applying Mascara with Natural eyelashes'),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          children: <Widget>[
            ...
            Card(
              child: Text('Too much product can lead to clumping. Giving the wand a little wipe will leave you with just the right amount.'),),
            SizedBox(
              height: 10.0,
            ),
            Text('Look up to lift your lashes.'),
            Card(
              child: Text('One should be able to see herself in the mirror out of their peripheral vision.'
            ...
            Text('Place the wand against the base of your lashes and wiggle it back and forth a little'),

            Card(
              child: 
              Text('You want the most product to be applied to the roots,'
           ...
           SizedBox(
            ...
            Card(
              child: Text('Mix mascaras to combine their specialties. For example,'
               'you could use lengthening mascara for one layer, then add a layer of thickening mascara on top. '),
            ),
            SizedBox(
              height: 10.0,
            ),
            Text("Don't neglect the lashes on the inner and outer part of your eyelid."),

            Card(
              child: Text("f you are having trouble reaching your inner lashes with your brush,"
            ...
            Card(
              child: Text('Either use a disposable wand or repurpose an old one (wash it thoroughly with soap and water first).'
            ...
            Card(
              child: Text("If you don't feel like you're getting the thick, voluminous lashes you want,"
