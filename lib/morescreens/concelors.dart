        ...
        children: <Widget>[
          ...
          Card(
             color: Colors.orange[100],
              child: ListTile(
            title: Text('Decide on  your favorite type', style:  TextStyle(fontWeight: FontWeight.bold, fontSize: 20.0),),
            subtitle: Text('There are different types of concealors like pencils, sticks and potted creams \n'
          ...
          Card(
             color: Colors.yellow[100],
              child: ListTile(
            title: Text('Prepare your face',  style:  TextStyle(fontWeight: FontWeight.bold, fontSize: 20.0),),
            subtitle: Text('Always wash your face before applying concealors \n'
            'Use makeup remover to get rid of any darkness around eyes'),
          )),
          Card(
             color: Colors.green[100],
              child: ListTile(
            title: Text('Cover up under circles' ,  style:  TextStyle(fontWeight: FontWeight.bold, fontSize: 20.0),),
            subtitle: Text('Apply the concealor in the shape of upside down triangle \n'
          ...
          Card(
              ...
              child: ListTile(
            title: Text('Apply concealors to acne and spots', style:  TextStyle(fontWeight: FontWeight.bold, fontSize: 20.0),),
            subtitle: Text('If you have spots/ acnes dab concealors on top of each mark then blend softly outwards to your skin \n'
          ...
          Card(
              ...
              child: ListTile(
            title: Text('Set the concealor', style:  TextStyle(fontWeight: FontWeight.bold, fontSize: 20.0),),
            subtitle: Text('After covering all spots, add a layer of foundation over the concealor, spread the foundation on your face \n'
          ...
          subtitle:RaisedButton(
            ...
            color: Colors.pink,
            child: Text('Watch video tutorial',  style:  TextStyle(fontWeight: FontWeight.bold, fontSize: 20.0, color: Colors.white),),
            onPressed: (){},
