        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            subtitle: Text(
                ...
                '2. Plastic or rubber curlers do not get a good'
                'enough grip to curl eyelashes well. These also break more easily.\n'
                '3. Even some metal curlers can be flimsy. Cheaper products do not last as long.\n'
                '4. Good brands of curlers include Shiseido, Shu Uemura, or Tarte. However always make sure to clean before using'),
          ),
          SizedBox(
            height: 10.0,
          ),
          ListTile(
            ...
            subtitle: Text(
                ...
                'However, you should avoid doing this.A hot eyelash curler can sting or'
          ...
          ListTile(
            ...
            subtitle: Text('Carefully place your eyelashes in between them :\n'
                ...
                '2. If you have lots of eyelashes already, you might have to do this in sections.\n'),
          ),
          SizedBox(
            height: 10.0,
          ),
          ...
          ListTile(
            ...
            subtitle: Text(
                ...
                '3. Curl the lashes one last time at the tips to put the final curl on them.'),
          ),
          SizedBox(
            height: 10.0,
          ),
          ...
          ListTile(
            ...
            subtitle: Text(
                ...
                'Metal lash comb is used after eyelash curler and after applying the mascara'
                'You can use it once before applying the mascara as well to smoothen your lashes for better application of mascara.'
