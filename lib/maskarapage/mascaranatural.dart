      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: <Widget>[
            ...
            Card(
              child: Text('Decide on what kind of maskara you want to use,'
                  'considering\n'
            ...
            Text('Apply any other makeup First',
                style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
            Card(
              child: Text('If you’re planning to wear eyeshadow, eyeliner,'
            ...
            Text('Curl your lashes first',
                style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
            Card(
              child: Text('Position the curler as close to the base of your'
            ...
            Card(
              child:
                  Text('Twisting will allow the brush to pick up the mascara,'
            ...
            Card(
              child:
                  Text('Mix mascaras to combine their specialties. For example,'
            ...
            Text(
                ...
                style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
            Card(
              child: Text('If you are having trouble reaching your inner'
            ...
            Text('Put mascara only on the roots of the lower lashes, ',
                style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
            Card(
              child: Text('Brushing on mascara on the full length of your'
            ...
            Text('Remove any mistakes with a cotton swab.',
                style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
            Card(
              child: Text('If you get mascara on your face or eyelid, allow'
            ...
            Text('De-clump with a clean mascara wand.',
                style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
            Card(
              child: Text('Either use a disposable wand or repurpose an old one'
            ...
            Text('Thicken your lashes even further with baby powder',
                style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
            Card(
              child: Text("If you don't feel like you're getting the thick,"
            ...
            Text('Remove your mascara every night with an eye makeup remover.',
                style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
            Card(
              child: Text('It might not seem like a big deal, but it can'
